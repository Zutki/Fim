...
public class ModItems {
    ...
    public static final Item OMNIHOE = registerItem("omnihoe",
            new ModHoeItem(ToolMaterials.NETHERITE, 1, 4,
                    new FabricItemSettings().group(ItemGroup.TOOLS).rarity(Rarity.EPIC), 5, true));
